...
function Navbar() {
  return (
    <>
      <nav className="bg-white border-gray-200 py-2.5 dark:bg-sky-700">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <NavLink to="/register" className="text-gray-900 bg-white hover:bg-white focus:ring-4 focus:ring-white font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0"
            >
